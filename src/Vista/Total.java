...
ProductoVo registro = new ProductoVo();
   ...
   public VentaVo venta = new VentaVo();
    ...
    private void initComponents() {
        ...
        lblCliente.setBackground(new java.awt.Color(204, 204, 204));
        ...
        lblVendedor.setBackground(new java.awt.Color(204, 204, 204));
        lblVendedor.setFont(new java.awt.Font("Apple SD Gothic Neo", 0, 14)); // NOI18N
        lblVendedor.setForeground(new java.awt.Color(51, 51, 51));
        ...
        lblPagar.setBackground(new java.awt.Color(204, 204, 204));
        ...
        lblDinero.setBackground(new java.awt.Color(204, 204, 204));
        lblDinero.setFont(new java.awt.Font("Apple SD Gothic Neo", 0, 14)); // NOI18N
        lblDinero.setForeground(new java.awt.Color(51, 51, 51));
